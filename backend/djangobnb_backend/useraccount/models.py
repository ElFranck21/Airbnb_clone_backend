...
class CustomUserManager(UserManager):
    ...
    def create_user(self, name=None, email=None, password=None, **extra_fileds):
        extra_fileds.setdefault('is_staff', False)
        extra_fileds.setdefault('is_superuser', False)
        return self._create_user(name, email, password, **extra_fileds)
    
    def create_superuser(self, name=None, email=None, password=None, **extra_fileds):
